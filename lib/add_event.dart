...
class AddEventPage extends StatefulWidget {
  ...
  AddEventPage({required this.tpoLoginId});
...
class _AddEventPageState extends State<AddEventPage> {
  ...
  void _submitForm() async {
    ...
    String Event_name = _Event_nameController.text.trim();
    String date = _dateController.text.trim();
    String message = _messageController.text.trim();

    // Validate the form (you can add more validation logic as needed)
    if (Event_name.isEmpty || date.isEmpty || message.isEmpty) {
          ...
          child: Column(
            children: [
              TextFormField(
                ...
                decoration: InputDecoration(labelText: 'Event_name'),
              ),
              TextFormField(
